...
function ConfirmarPage() {
  ...
  // Cupom só entra se o cliente escolheu na área de cupons.
  ...
  /** WhatsApp: o pedido nasce só agora, ao confirmar o envio. */
            ...
            <section className="mt-3 rounded-2xl border-2 border-border bg-card p-3">
                ...
                <div className="flex items-center gap-2">
                  {applied && (
                    <button
                      ...
                      className="rounded-xl border-2 border-border px-3 py-2 text-sm font-bold text-muted-foreground active:scale-95"
                    >
                      Tirar
                    </button>
                  )}
              ...
              <div className="flex items-center justify-between gap-3 border-t border-border py-2">
                ...
                <button
                  ...
                  disabled={balance <= 0}
                  className={`rounded-xl px-4 py-2 text-sm font-black disabled:opacity-40 active:scale-95 ${
                    useCoins
                      ? "bg-[oklch(0.72_0.17_75)] text-white"
                      : "bg-muted text-foreground"
                  }`}
                >
                  {useCoins ? "Usando moedas" : "Usar moedas"}
                </button>
              </div>
        ...
        <div className="fixed inset-x-0 bottom-0 z-20 border-t border-border bg-background/95 px-3 pb-3 pt-2 backdrop-blur">
          <div className="mx-auto flex max-w-3xl flex-col gap-2">
            ...
            <button
              ...
              disabled={busy !== ""}
              className="flex w-full items-center justify-center gap-3 rounded-2xl bg-[oklch(0.62_0.19_145)] py-5 text-2xl font-black text-white disabled:opacity-50 active:scale-[0.99]"
            >
            ...
            <button
              ...
              disabled={busy !== ""}
              className="w-full rounded-2xl bg-[oklch(0.55_0.22_255)] py-5 text-2xl font-black text-white disabled:opacity-50 active:scale-[0.99]"
            >
